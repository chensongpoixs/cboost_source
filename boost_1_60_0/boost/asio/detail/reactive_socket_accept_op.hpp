...
public:
  ...
  static bool do_perform(reactor_op* base)
  {
    ...
    if (new_socket != invalid_socket)
    {
      ...
      if (!o->peer_.assign(o->protocol_, new_socket, o->ec_))  //////// add event epoll_ctl
...
private:
  socket_type socket_;
  socket_ops::state_type state_; // socket connect status 
  Socket& peer_;
  Protocol protocol_;
...
public:
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    if (owner)
    {
      ...
      BOOST_ASIO_HANDLER_INVOCATION_END; //  // call_back usr async_accept -> ()
    }
  }
