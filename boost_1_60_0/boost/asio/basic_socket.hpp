...
class basic_socket  // Protocol -> tcp 
  : public basic_io_object<SocketService>, // SocketService --> stream_socket_service
    public socket_base
{
public:
    ...
    : basic_io_object<SocketService>(io_service)
  {
    ...
    this->get_service().open(this->get_implementation(), protocol, ec);  // basic_io_object-> stream_socket_service
